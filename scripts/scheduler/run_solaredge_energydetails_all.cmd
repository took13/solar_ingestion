...
set LOG_FILE=%LOG_DIR%\solaredge_energydetails_%LOG_DATE%.log

cd /d %PROJECT_DIR%

echo ================================================== >> "%LOG_FILE%"
echo [%DATE% %TIME%] START SOLAREDGE ENERGYDETAILS ALL >> "%LOG_FILE%"
...
echo [%DATE% %TIME%] END SOLAREDGE ENERGYDETAILS ALL exit_code=%EXIT_CODE% >> "%LOG_FILE%"
echo. >> "%LOG_FILE%"
